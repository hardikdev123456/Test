...
function emp_form_register_post_types() {

    function emp_form_embed_register_cpt($single_label, $plural_label, $type, $slug, $cap_type, $icon, $heirarchical, $supports, $public, $public_query, $has_archive) {
    ...
    //Form Post Type
    emp_form_embed_register_cpt('EMP Embed Form', 'EMP Embed Forms', 'emp_form_embed_type', 'empform', 'post', 'dashicons-welcome-write-blog', true, array( 'title' ), false, false, false );

}
add_action( 'init', 'emp_form_register_post_types' );
