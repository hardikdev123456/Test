    ...
    $(document).ready(function () {
        ...
        $('div.section > div').each(function(i) {
            if( i % SITE.data.field_numbers == 0 ) {
                $(this).nextAll().andSelf().slice(0,SITE.data.field_numbers).wrapAll('<div class="row setup-content" id="step-'+j+'"></div>');
                ...
                if(j==1) {
                    ...
                    $('div#step-'+j).append('<div class="form-group alert alert-success form-submit-success"></div><div class="form-group alert alert-danger form-submit-danger"></div><div class="form-group"><button type="button" id="step-'+j+'" class="btn btn-black nextBtn  regbutton">Next</button></div><div class="form-group"><button type="button" id="step-'+j+'" class="btn btn-black backBtn  regbutton">Back</button></div>');
        ...
        navListItems.click(function (e) {
            ...
            var numItems = $('div.row.setup-content').length-1;
        ...
        allNextBtn.click(function(){
            ...
            var sex = $("input:radio").is(':checked');
